...
#define VSS_CFETS_CANCEL_DEAL		  176  
	...
	//华泰融券通日行情数据
#define VSS_HSTC_TD_LEND_STATISTICS   180
...
// 华泰融券通日行情数据结构
struct MsgTD_HTSC_Lend_Daily_Stats
{
	int         nTradeDate;         //交易日
	int         nDate;              //行情日期YYYYMMDD
	int         nTime;              //行情时间HHMMSSsss
	__int64     nHtscBorrowTradeVolume; //融券通平台借入成交额*10000
	__int64     nHtscLendTradeVolume;   //融券通平台融出成交额*10000
	__int64     nMarketTradeVolume;     //转融券市场成交额*10000
};

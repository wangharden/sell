...
#define JYLB_JHMM             131         //激活密码
#define JYLB_ZXMM             132         //注销密码
...
const char table_sokhgtzjxx[] = "tSOKHGTZJXX";     //期权客户柜台资金信息
const char table_fc_zjzh[] = "tSO_FC_ZJZH";     //期权资金库信息
